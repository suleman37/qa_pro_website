      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          {roles.map((role, index) => (
            <div 
              key={role.title}
              className="group bg-card rounded-2xl p-6 shadow-soft hover:shadow-elevated transition-all duration-300 border border-border/50 hover:border-primary/30 relative overflow-hidden"
            >
              {/* Hover glow effect */}
              ...
              <div className="relative z-10">
                <div className={`w-14 h-14 rounded-2xl ${role.color === 'primary' ? 'bg-primary/10' : 'bg-accent/10'} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
